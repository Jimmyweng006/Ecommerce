...
import com.jimmyweng.ecommerce.service.order.OrderQueryService;
...
public class OrderController {
    ...
    public OrderResponse getOrder(@PathVariable Long orderId, Authentication authentication) {
        ...
        return OrderResponse.from(orderQueryService.getOrderForRequester(orderId, authentication.getName(), isAdmin));
    }
